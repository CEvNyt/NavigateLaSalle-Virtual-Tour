...
var AutorotatePlugin = class extends AbstractConfigurablePlugin {
  ...
  __onKeyPress(e) {
    if (this.viewer.state.keyboardEnabled && e.key === constants_exports.KEY_CODES.Space && !e.ctrlKey && !e.altKey && !e.shiftKey && !e.metaKey) {
      this.toggle();
      e.preventDefault();
    }
  }
...
AutorotatePlugin.VERSION = "5.13.1";
...
@photo-sphere-viewer/autorotate-plugin/index.module.js:
  (*!
   * Photo Sphere Viewer / Autorotate Plugin 5.13.1
